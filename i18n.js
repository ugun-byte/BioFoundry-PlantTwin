...
export const I18N_DICTIONARY = {
  ko: {
    ...
    tabOverview: "Overview (콕핏)",
    tabTelemetry: "Telemetry (원격계측)",
    tabOptimization: "Optimization (AI 최적화)",
    tabExperiments: "Experiments (가상 실험)",
    tabReports: "Reports (규격서 리포트)",
    ...
    envControlsHeading: "환경 제어 시스템 (13채널)",
    sliderPpfd: "광량 (PPFD)",
    sliderPhotoperiod: "일장 (광주기)",
    sliderRed: "Red 분광",
    sliderBlue: "Blue 분광",
    sliderGreen: "Green 분광",
    sliderFarRed: "Far-Red 분광",
    sliderDayTemp: "주간 온도",
    sliderNightTemp: "야간 온도",
    sliderHumidity: "상대습도",
    sliderCo2: "CO₂ 농도",
    sliderEc: "양액 전기전도도",
    sliderUvb: "UV-B 유전자 펄스",
    ...
    hudLeafHeader: "엽면 생체 분석 (LEAF)",
    hudRootHeader: "근권 환경 분석 (ROOT)",
    hudChl: "엽록소 a/b",
    hudGs: "기공전도도",
    hudNpq: "비광화학적 소광",
    hudRootRh: "근권 습도",
    ...
    hudRootO2: "용존 산소(O₂)",
    timeWarpLabel: "시간 가속",
    stageSeedling: "유묘기 (Seedling)",
    stageVegetative: "영양 생장기 (Vegetative)",
    stageFlowering: "개화 및 유효분자 축적기 (Harvest)",
